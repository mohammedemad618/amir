...
export const metadata: Metadata = {
  ...
  description: 'تعرف على خبرات الدكتور ومسار العمل المهني والتدريب التخصصي.',
};
...
const values = [
  {
    ...
    description: 'نعتمد على أسس علمية واضحة لضمان جودة المحتوى التدريبي وفعاليته.',
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  },
  {
    ...
    description: 'نحوّل المعرفة النظرية إلى خطوات عملية قابلة للقياس والتطبيق.',
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
...
const timeline = [
  ...
  },
  {
    ...
    description: 'الحصول على شهادات اعتماد دولية في تصميم المناهج التدريبية الطبية.',
  },
  {
    year: '2024',
    title: 'منصة تدريب متكاملة',
    description: 'تحويل الخبرة إلى مسارات رقمية تضمن تجربة تعلم متقدمة.',
  },
];
...
export default function AboutPage() {
  return (
    <div className="container section">
      <section className="relative overflow-hidden rounded-[2.5rem] bg-hero-glow border border-primary-100 shadow-glow panel-pad mb-20 group">
        <DecorativeCircles className="opacity-40 group-hover:opacity-60 transition-opacity duration-1000" />
        <DotPattern className="opacity-10" />

        {/* Animated Orbs */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-primary-200/20 blur-[120px] rounded-full -translate-y-1/2 translate-x-1/2 animate-pulse" />
        <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-sky-200/20 blur-[120px] rounded-full translate-y-1/2 -translate-x-1/2" />
        ...
        <div className="relative grid grid-cols-1 lg:grid-cols-[0.8fr_1.2fr] gap-12 items-center">
          <div className="relative mx-auto lg:mx-0 max-w-[400px]">
            ...
            {/* Experience Badge */}
            <div className="absolute -bottom-6 -right-6 z-20 bg-white/90 backdrop-blur-md p-5 rounded-3xl shadow-glow border border-primary-100 animate-bounce-slow">
              <div className="text-center">
                <span className="block text-3xl font-black text-primary-600 leading-none">+20</span>
                <span className="text-xs font-bold text-ink-600 uppercase tracking-wider">عاماً من الخبرة</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <Badge variant="primary" size="md" className="py-2 px-5 text-sm uppercase tracking-widest shadow-lg shadow-primary-500/10 scale-105 origin-right">
                مسار الدكتور المهني
              </Badge>
              <h1 className="heading-1 !text-5xl lg:!text-6xl bg-gradient-to-l from-primary-800 via-primary-600 to-sky-600 bg-clip-text text-transparent !leading-[1.2]">
                خبرة سريرية تمتد لأكثر من عقدين
              </h1>
              <p className="body-lg text-ink-700 leading-relaxed max-w-2xl">
                نلتزم بتقديم تجربة تعليمية فريدة تجمع بين العمق العلمي والتبسيط العملي، لنساعد ممارسي الصحة على تحقيق التميز المهني.
              </p>
            </div>
      ...
      <section className="mb-24 relative overflow-hidden py-10">
        <div className="absolute top-1/2 left-0 w-full h-[600px] bg-primary-50/50 -translate-y-1/2 -z-10 blur-[100px]" />

        <SectionHeading
          eyebrow="الرحلة المهنية"
          title="محطات الخبرة"
          subtitle="محطات رئيسية شكلت المنهج الحالي في التدريب والتطوير."
          align="center"
        />

        <div className="mt-16 relative max-w-4xl mx-auto">
          {/* Vertical Line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-primary-100 via-primary-400 to-primary-100 -translate-x-1/2 hidden md:block" />
          ...
          <div className="space-y-12 relative">
            {timeline.map((item, idx) => (
              ...
              >
                {/* Year Circle (Center) */}
                <div className="absolute left-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-white border-4 border-primary-500 shadow-xl z-10 hidden md:flex items-center justify-center font-black text-primary-600">
                  {item.year}
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="body-lg text-ink-700">
              يشمل العمل السريري والتدريبي تقديم حلول متكاملة للمختصين في مجالات متنوعة، مع التركيز على أعلى معايير الجودة العالمية.
            </p>
            <ul className="space-y-4">
              {[
                ...
                <li key={i} className="flex gap-3 items-center text-ink-800 font-semibold group">
                  <span className="w-8 h-8 rounded-lg bg-primary-100 text-primary-600 flex items-center justify-center flex-shrink-0 group-hover:bg-primary-600 group-hover:text-white transition-colors">
