...
export const metadata: Metadata = {
  title: 'الدكتور عامر سلمان عرابي - منصة التغذية العلاجية والعلاج الوظيفي',
  description: 'منصة تعليم طبي احترافية في التغذية العلاجية والعلاج الوظيفي مع دورات متخصصة وشهادات إتمام',
  keywords: ['التغذية العلاجية', 'العلاج الوظيفي', 'دورات طبية', 'د. عامر عرابي'],
  authors: [{ name: 'الدكتور عامر سلمان عرابي' }],
  openGraph: {
    title: 'الدكتور عامر سلمان عرابي - منصة التغذية العلاجية والعلاج الوظيفي',
